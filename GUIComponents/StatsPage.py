...
class StatsPage(QWidget):
    ...
    def set_layout(self):
        button = PyCute.Button(default_text='Go to upload page', connect_func=self.parent_widget.switch_page)
        layout = PyCute.add_to_layout(QVBoxLayout(), button)
        self.setLayout(layout)

    def build_gui(self):
        print(self.data_table.to_str())
